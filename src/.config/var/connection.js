...
export const _dbstring = process.env.MONGO_URL;
...
export const _stripe_secrete_key_live = process.env.STRIPE_SECRETE_KEY_LIVE;
...
export const _dbreviews = "col_reviews";
...
export const _stripe_connect_accLink_refresh_url = process.env.STRIPE_CONNECT_ACCLINK_REFRESH_URL;
export const _stripe_connect_accLink_return_url = process.env.STRIPE_CONNECT_ACCLINK_RETURN_URL;
